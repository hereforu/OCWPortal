...
jQuery(window).load(function() {
	...
	*/
	...
	$('.portfolio-filters a').on('click', function(e){
		e.preventDefault();
		var clicked_pid = $(this).attr('pid');
		var example = $('#'+clicked_pid);
		if(!$(this).hasClass('active')) {
	    	...
	    	if(clicked_filter != 'all') {
	    		...
	    		$('.portfolio-box:not(.' + clicked_filter + ')', example).css('display', 'none');
	    		$('.portfolio-box:not(.' + clicked_filter + ')', example).removeClass('portfolio-box');
